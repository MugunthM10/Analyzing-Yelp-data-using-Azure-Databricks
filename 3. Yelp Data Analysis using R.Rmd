...
# business <- read.df("dbfs:/mnt/m10pro/parquet_to_delta/business.delta", source = "delta")
# reviews <- read.df("dbfs:/mnt/m10pro/parquet_to_delta/review.delta", source = "delta")

#If you want the delta file from blob storage as dataframe

reviews_json <- stream_in(file("C:/Users/mugun/Downloads/Final Year project/yelp open source dataset/Yelp Dataset/yelp_academic_dataset_review.json"))

business_json <- stream_in(file("C:/Users/mugun/Downloads/Final Year project/yelp open source dataset/Yelp Dataset/yelp_academic_dataset_business.json"))
